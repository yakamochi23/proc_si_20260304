...
\begin{document}
    ...
    \section{提案手法}
        ...
        \subsection{姿勢情報の更新}
            式\ref{eq:final_cost}のコスト関数$\mathcal{L}_{\mathrm{match}}(\cdot)$を用いたAssociationにより，トラック$\mathbf{x}_{i}$と検出結果$\mathbf{y}_{j}$が対応付けられたとする．このとき，$\mathbf{x}_{i}$が保持する姿勢情報$\{ \mathbf{g}_{i}, c_{k} \}$は式\ref{eq:update_pose_info}によって更新させる．
                \begin{equation}
