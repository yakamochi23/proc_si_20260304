...
\begin{document}
    ...
    \section{評価実験}
        ...
        \subsection{実験条件}
            ...
            本研究では，VIP-HTD(Vision and Image Processing Hokey Tracking Dataset)\cite{VIP-HTD2024}を用いて，従来手法であるOC-SORTと提案手法の比較評価を行った．VIP-HTDは，試合中のアイスホッケー選手を追跡対象とするMOTデータセットであり，計22シーケンス（訓練:14/検証:1/テスト:7），計73,890フレーム（訓練:45,396/検証:2,981/テスト:25,513）で構成されている．
